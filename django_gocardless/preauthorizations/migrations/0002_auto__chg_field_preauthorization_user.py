...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PreAuthorization.user'
        db.alter_column(u'preauthorizations_preauthorization', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth_custom.User']))

    def backwards(self, orm):

        # Changing field 'PreAuthorization.user'
        db.alter_column(u'preauthorizations_preauthorization', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'preauthorizations.preauthorization': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'preauthorizations'", 'null': 'True', 'to': u"orm['auth_custom.User']"})
        },
        u'uploads.upload': {
