...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreAuthorization'
        db.create_table(u'preauthorizations_preauthorization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django_fsm.db.fields.fsmfield.FSMField')(default='notsent', max_length=50)),
            ('max_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('interval_length', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('interval_unit', self.gf('django.db.models.fields.CharField')(default='month', max_length=10)),
            ('expires_at', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('interval_count', self.gf('django.db.models.fields.SmallIntegerField')(default=None, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('setup_fee', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=10, decimal_places=2, blank=True)),
            ('calendar_intervals', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth_custom.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'preauthorizations', ['PreAuthorization'])


    def backwards(self, orm):
        # Deleting model 'PreAuthorization'
        db.delete_table(u'preauthorizations_preauthorization')
    ...
    models = {
        ...
        u'preauthorizations.preauthorization': {
            'Meta': {'object_name': 'PreAuthorization'},
            'calendar_intervals': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'expires_at': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interval_count': ('django.db.models.fields.SmallIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'interval_length': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'interval_unit': ('django.db.models.fields.CharField', [], {'default': "'month'", 'max_length': '10'}),
            'max_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            ...
            'setup_fee': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'status': ('django_fsm.db.fields.fsmfield.FSMField', [], {'default': "'notsent'", 'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth_custom.User']", 'null': 'True', 'blank': 'True'})
        },
        u'uploads.upload': {
    ...
    complete_apps = ['preauthorizations']