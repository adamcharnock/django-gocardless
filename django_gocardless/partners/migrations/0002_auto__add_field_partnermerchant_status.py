...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerMerchant.status'
        db.add_column(u'partner_partnermerchant', 'status',
                      self.gf('django_fsm.db.fields.fsmfield.FSMField')(default='pending', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerMerchant.status'
        db.delete_column(u'partner_partnermerchant', 'status')
