...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'partner_partnermerchant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth_custom.User'])),
        ...
        db.send_create_signal(u'partner', ['PartnerMerchant'])


    def backwards(self, orm):
        # Deleting model 'PartnerMerchant'
        db.delete_table(u'partner_partnermerchant')
